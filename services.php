...
<head>
  ...
  <title>Services - Marka Printing</title>
...
<body class="services">
  <div id="maximage">
    <img src="images/background-services-1940x1229.jpg">
  </div>
  <?php include('nav.inc') ?>
  ...
  <div class="row">
    <div class="fourteen columns centered text-center">
      ...
      <h1 class="markaHeading services">SERVICES PACKED WITH VALUE</h1>
      ...
      <div class="fourteen columns centered">
          ...
          <div class="row">
            ...
            <div class="twelve columns centered">
              ...
              <p>Just in Time (JIT) delivery programs</p>
              <p>Vendor Managed Inventory (VMI) </p> 
              <p>Unique Account Management model</p>
              <p>Cross manufacturing</p>
              <p>In House die making</p>
              <p>In House structural and graphic design</p>
